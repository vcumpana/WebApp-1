...
public class UserController {
    ...
    public String showUsersByGender(ModelMap model, @ModelAttribute("gender") Gender gender) {
        if (gender == Gender.FEMALE) {
            model.addAttribute("genderName", "girls");
        } else {
            model.addAttribute("genderName", "boys");
        }
        model.addAttribute("users", userService.getAllUsers(gender));
        return "welcome";
    }
