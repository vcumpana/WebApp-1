...
public class UserService {
    ...
    public List<User> getGirlUsers() { return UsersDatabaseImitation.getListOfGirlsUsers();
    }

    public  List<User> getBoysUsers() { return UsersDatabaseImitation.getListOfBoysUsers();
    }
}
